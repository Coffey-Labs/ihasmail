...
export const catalog: Catalog = {
  strings: {
    ...
    "That isn't a valid email address. Use a full address, such as name@example.com.": "Das ist keine gültige E-Mail-Adresse. Verwenden Sie eine vollständige Adresse wie name@example.com.",
