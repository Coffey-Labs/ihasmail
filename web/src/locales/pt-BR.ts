...
export const catalog: Catalog = {
  strings: {
    ...
    "That isn't a valid email address. Use a full address, such as name@example.com.": "Esse não é um endereço de e-mail válido. Use um endereço completo, como name@example.com.",
