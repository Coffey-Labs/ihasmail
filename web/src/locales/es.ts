...
export const catalog: Catalog = {
  strings: {
    ...
    "That isn't a valid email address. Use a full address, such as name@example.com.": "Esa no es una dirección de correo válida. Use una dirección completa, como name@example.com.",
