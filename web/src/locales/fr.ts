...
export const catalog: Catalog = {
  strings: {
    ...
    "That isn't a valid email address. Use a full address, such as name@example.com.": "Ce n’est pas une adresse e-mail valide. Utilisez une adresse complète, comme name@example.com.",
