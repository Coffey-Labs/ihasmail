...
export const catalog: Catalog = {
  strings: {
    ...
    "That isn't a valid email address. Use a full address, such as name@example.com.": "Это недопустимый адрес электронной почты. Укажите полный адрес, например name@example.com.",
