 ...
 * -- i would keep the more formal "u" and "uw" --
...
export const catalog: Catalog = {
  strings: {
    ...
    "Added {date}": "{date} toegevoegd", /* the original value "Toegevoegd op {date}" means "Added on {date}" */
    "This domain is disabled on the server.": "Dit domein is op de server uitgeschakeld.",
    "Your role lets you view domains but not change them.": "Met uw rol kunt u domeinen bekijken, maar niet wijzigen.", /* if with 'role' you mean 'rights', it's more natural to say: "Met uw rechten kunt u domeinen bekijken maar niet wijzigen."  */
    ...
    "Mail to the same address at any of these names reaches the same account. Changes apply when you save.": "E-mails aan hetzelfde adres onder een van deze namen komen in hetzelfde account. Wijzigingen worden doorgevoerd na opslaan.",
    ...
    "Mail to these addresses is delivered to this group. Changes apply when you save.": "E-mails aan deze adressen worden bij deze groep bezorgd. Wijzigingen worden doorgevoerd na opslaan.",
    ...
    "Mail to these addresses goes to the list too. Changes apply when you save.": "E-mails aan deze adressen gaan ook naar de lijst. Wijzigingen worden doorgevoerd na opslaan.",
    ...
    "Mail to the list is passed on to every recipient, on this server or anywhere else. Paste several at once if you like. Changes apply when you save.": "E-mails naar de lijst worden doorgestuurd naar elke ontvanger op deze server of elders. U kunt er meerdere tegelijk plakken. Wijzigingen worden doorgevoerd na opslaan.",
    ...
    "Still used by {things}. Move them to another role first.": "Nog in gebruik bij {things}. Geef ze eerst een andere rol.", /* this translation says: "Still used by {things}. Give them another role first". But if you truly mean "Move them to another role first" the translation should be: "Nog in gebruik bij {things}. Verplaats deze eerst naar een andere rol." */
    "Delete role": "Rol verwijderen",
    ...
    "Mail to these addresses is delivered to this account. Changes apply when you save.": "E-mail aan deze adressen wordt in dit account afgeleverd. Wijzigingen worden doorgevoerd na opslaan.",
