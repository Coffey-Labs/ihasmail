...
export const catalog: Catalog = {
  strings: {
    ...
    "That isn't a valid email address. Use a full address, such as name@example.com.": "Dat is geen geldig e-mailadres. Gebruik een volledig adres, zoals name@example.com.",
